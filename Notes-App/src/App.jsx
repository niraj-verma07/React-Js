...
const App = () => {
  ...
  const [details, setDetails] = useState(""); //For Details

  const [task, setTask] = useState([]); //For Add Note Button
  ...
  return (
    <div className="h-full  min-h-screen lg:flex bg-black text-white">
      <form
        onSubmit={(e) => {
          submitHandler(e);
        }}
